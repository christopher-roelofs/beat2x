...
void Game::UpdateLevel()
{
    ...
    switch(mControlMode)
    {
        case 0:
        {
            if (mInputHandler->IsY()) keysPressed=keysPressed|(1);
            if (mInputHandler->IsA()) keysPressed=keysPressed|(1<<1);
            if (mInputHandler->IsB()) keysPressed=keysPressed|(1<<2);
            if (mInputHandler->IsX()) keysPressed=keysPressed|(1<<3);
            break;
        }
        case 1:
        {
        ...
        case 2:
        {
            if (mInputHandler->IsY()||mInputHandler->IsLeft()||mInputHandler->IsUpLeft()) keysPressed=keysPressed|(1);
            if (mInputHandler->IsA()||mInputHandler->IsRight()|mInputHandler->IsDownRight()) keysPressed=keysPressed|(1<<1);
            if (mInputHandler->IsB()||mInputHandler->IsDown()||mInputHandler->IsDownLeft()) keysPressed=keysPressed|(1<<2);
            if (mInputHandler->IsX()||mInputHandler->IsUp()||mInputHandler->IsUpRight()) keysPressed=keysPressed|(1<<3);
